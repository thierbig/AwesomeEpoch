...
struct SpellRec {
	using HasShapeshiftFlag_t = bool(*)(SpellRec*);
	inline static auto HasShapeshiftFlagFn = reinterpret_cast<HasShapeshiftFlag_t>(0x00800950);
	bool HasShapeshiftFlag() { return HasShapeshiftFlagFn(this); }
