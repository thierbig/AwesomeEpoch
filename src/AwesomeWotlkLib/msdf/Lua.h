...
inline void luaL_checktype(lua_State* L, int idx, int t) { reinterpret_cast<fn_luaL_checktype>(0x0084F960)(L, idx, t); }
inline const char* luaL_checklstring(lua_State* L, int idx, size_t* len) { return reinterpret_cast<fn_luaL_checklstring>(0x0084F9F0)(L, idx, len); }
inline lua_Number luaL_checknumber(lua_State* L, int idx) { return reinterpret_cast<fn_luaL_checknumber>(0x0084FAB0)(L, idx); }
inline void* lua_touserdata(lua_State* L, int idx) { return reinterpret_cast<fn_lua_touserdata>(0x0084E1C0)(L, idx); }
inline double lua_tonumber(lua_State* L, int n_param) { return reinterpret_cast<fn_lua_tonumber>(0x0084E030)(L, n_param); }
inline const char* lua_tolstring(lua_State* L, int idx, size_t* len) { return reinterpret_cast<fn_lua_tolstring>(0x0084E0E0)(L, idx, len); }
inline bool lua_toboolean(lua_State* L, int idx) { return reinterpret_cast<fn_lua_toboolean>(0x0084E0B0)(L, idx); }
inline void lua_pushstring(lua_State* L, const char* str) { reinterpret_cast<fn_lua_pushstring>(0x0084E350)(L, str); }
inline void lua_pushboolean(lua_State* L, bool b) { reinterpret_cast<fn_lua_pushboolean>(0x0084E4D0)(L, b); }
inline void lua_pushvalue(lua_State* L, int idx) { reinterpret_cast<fn_lua_pushvalue>(0x0084DE50)(L, idx); }
inline void lua_pushnumber(lua_State* L, lua_Number v) { reinterpret_cast<fn_lua_pushnumber>(0x0084E2A0)(L, v); }
inline void lua_pushlightuserdata(lua_State* L, void* data) { reinterpret_cast<fn_lua_pushlightuserdata>(0x0084E500)(L, data); }
inline void lua_pushcclosure(lua_State* L, lua_CFunction func, int c) { reinterpret_cast<fn_lua_pushcclosure>(0x0084E400)(L, func, c); }
inline void lua_pushnil(lua_State* L) { reinterpret_cast<fn_lua_pushnil>(0x0084E280)(L); }
inline void lua_rawseti(lua_State* L, int idx, int pos) { reinterpret_cast<fn_lua_rawseti>(0x0084EA00)(L, idx, pos); }
inline void lua_rawgeti(lua_State* L, int idx, int pos) { reinterpret_cast<fn_lua_rawgeti>(0x0084E670)(L, idx, pos); }
inline void lua_rawset(lua_State* L, int idx) { reinterpret_cast<fn_lua_rawset>(0x0084E970)(L, idx); }
inline void lua_rawget(lua_State* L, int idx) { reinterpret_cast<fn_lua_rawget>(0x0084E600)(L, idx); }
inline void lua_setfield(lua_State* L, int idx, const char* str) { reinterpret_cast<fn_lua_setfield>(0x0084E900)(L, idx, str); }
inline void lua_getfield(lua_State* L, int idx, const char* str) { reinterpret_cast<fn_lua_getfield>(0x0084E590)(L, idx, str); }
inline int lua_next(lua_State* L, int idx) { return reinterpret_cast<fn_lua_next>(0x0084EF50)(L, idx); }
inline void lua_insert(lua_State* L, int idx) { reinterpret_cast<fn_lua_insert>(0x0084DCC0)(L, idx); }
inline int lua_gettop(lua_State* L) { return reinterpret_cast<fn_lua_gettop>(0x0084DBD0)(L); }
inline void lua_settop(lua_State* L, int idx) { reinterpret_cast<fn_lua_settop>(0x0084DBF0)(L, idx); }
inline int lua_objlen(lua_State* L, int idx) { return reinterpret_cast<fn_lua_objlen>(0x0084E150)(L, idx); }
inline int lua_type(lua_State* L, int idx) { return reinterpret_cast<fn_lua_type>(0x0084DEB0)(L, idx); }
inline int lua_pcall(lua_State* L, int argn, int retn, int eh) { return reinterpret_cast<fn_lua_pcall>(0x0084EC50)(L, argn, retn, eh); }
inline int lua_GetParamValue(lua_State* L, int idx, int default_) { return reinterpret_cast<fn_lua_GetParamValue>(0x00815500)(L, idx, default_); }
inline void lua_createtable(lua_State* L, int narr, int nrec) { reinterpret_cast<fn_lua_createtable>(0x0084E6E0)(L, narr, nrec); }
inline void* lua_newuserdata(lua_State* L, size_t size) { return reinterpret_cast<fn_lua_newuserdata>(0x0084F0F0)(L, size); }
inline int lua_setmetatable(lua_State* L, int idx) { return reinterpret_cast<fn_lua_setmetatable>(0x0084EA90)(L, idx); }
inline CSimpleFrame* lua_toframe(lua_State* L, int idx) { return reinterpret_cast<fn_lua_toframe>(0x004A81B0)(L, idx); }
inline void lua_pushframe(lua_State* L, CSimpleFrame* frame) { lua_rawgeti(L, REGISTRYINDEX, frame->GetRefTable()); }
...
inline bool CheckSlashCommandExists(const char* cmdKey) {
	...
	lua_getglobal(L, globalVar.c_str());
...
inline void RegisterSlashCommand(const char* cmdKey, const char* slashStr, lua_CFunction func) {
	...
	if (lua_istable(L, -1)) {
		lua_pushvalue(L, -2);
		lua_setfield(L, -2, cmdKey);
	}
	lua_pop(L, 2);

	std::string globalVar = "SLASH_" + std::string(cmdKey) + "1";
	lua_pushstring(L, slashStr);
	lua_setglobal(L, globalVar.c_str());
}
...
inline void RegisterLuaBinding(const char* bindsSet, const char* bindingName, const char* bindingText, const char* bindingHeaderName, const char* bindingHeaderText, const char* luaScript) {
	...
	std::ranges::transform(upperHeader, upperHeader.begin(), [](unsigned char c) { return std::toupper(c); });

	std::string upperName = bindingName ? bindingName : "";
	std::ranges::transform(upperName, upperName.begin(), [](unsigned char c) { return std::toupper(c); });
